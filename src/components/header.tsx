  ...
  return (
    ...
    <header className={header_styles} >
      ...
      <div className="relative text-Just_White self-center " >
        ...
        <a href="" className="text-sm absolute inset-x-0 top-40 shadow-lg font-bold bg-Off_White text-Warm_Black p-2" >Conoce nuestros planes <span className="ml-1 bg-[url(/Bata-bit/assets/mdi_keyboard_arrow_down.svg)] pl-4" ></span></a>
      </div>
    </header>
    </>
  )
